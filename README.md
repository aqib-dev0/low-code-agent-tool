...
[![codecov](https://codecov.io/gh/aqib-dev0/low-code-agent-tool/branch/main/graph/badge.svg)](https://codecov.io/gh/aqib-dev0/low-code-agent-tool)
...
[![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://github.com/aqib-dev0/low-code-agent-tool/graphs/commit-activity)
...
Low Code Agent Tool is an open-source platform for building AI-powered teammates. Create agents that act as your AI Product Manager, AI Software Engineer, AI Marketing Lead, AI Support Agent, and more. Each agent can be equipped with custom tools, knowledge bases, and integrations to handle real work autonomously.

**Why Low Code Agent Tool?**
...
1. **Clone the repository**
  ```bash
  git clone https://github.com/aqib-dev0/low-code-agent-tool.git
  cd low-code-agent-tool
  ```
...
```bash
# Database
DATABASE_URL=postgresql://app:app@localhost:5432/low_code_agent
...
AWS_BUCKET_NAME=low-code-agent-storage
...
|----------|-------------|--------|
| **Main CI** | Orchestrates all tests | [![CI Pipeline](https://github.com/aqib-dev0/low-code-agent-tool/actions/workflows/main-ci.yml/badge.svg)](https://github.com/aqib-dev0/low-code-agent-tool/actions/workflows/main-ci.yml) |
| **API Tests** | Python unit & integration tests | [![API Tests](https://github.com/aqib-dev0/low-code-agent-tool/actions/workflows/api-tests.yml/badge.svg)](https://github.com/aqib-dev0/low-code-agent-tool/actions/workflows/api-tests.yml) |
| **Web Tests** | Frontend linting & type checks | [![Web Tests](https://github.com/aqib-dev0/low-code-agent-tool/actions/workflows/web-tests.yml/badge.svg)](https://github.com/aqib-dev0/low-code-agent-tool/actions/workflows/web-tests.yml) |
| **Style Check** | Code formatting & linting | [![Style](https://github.com/aqib-dev0/low-code-agent-tool/actions/workflows/style.yml/badge.svg)](https://github.com/aqib-dev0/low-code-agent-tool/actions/workflows/style.yml) |
| **Docker Build** | Container build validation | [![Docker](https://github.com/aqib-dev0/low-code-agent-tool/actions/workflows/docker-build.yml/badge.svg)](https://github.com/aqib-dev0/low-code-agent-tool/actions/workflows/docker-build.yml) |


### Code Coverage


We use [Codecov](https://codecov.io/gh/aqib-dev0/low-code-agent-tool) for code coverage tracking:
...
If you find Low Code Agent Tool useful, please consider giving us a star ⭐️
...
- 🐛 **Issues**: Report bugs via [GitHub Issues](https://github.com/aqib-dev0/low-code-agent-tool/issues)
...
Low Code Agent Tool is actively maintained and in production use. We follow semantic versioning and maintain backward compatibility wherever possible.
...
**Built with ❤️ by the Low Code Agent Tool Community**
