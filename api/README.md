# Low Code Agent Tool API


Production-ready API backend for the Low Code Agent Tool AI application platform.
...
[![codecov](https://codecov.io/gh/aqib-dev0/low-code-agent-tool/branch/main/graph/badge.svg?flag=api)](https://codecov.io/gh/aqib-dev0/low-code-agent-tool)
...
export SMTP_FROM_NAME="Low Code Agent Tool"
...
- GitHub Issues: [Project Issues](https://github.com/aqib-dev0/low-code-agent-tool/issues)
